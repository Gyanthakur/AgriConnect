      ...
      <div className="container mx-auto">
        ...
        <div className={`${isDarkMode ? "bg-gray-700" : "bg-gray-200"} mb-5`}>
          <section className="mt-6">
            <h3 className="pt-6 pl-6 mb-4 text-2xl font-semibold">
              All Merchants
            </h3>
            {merchants.length > 0 ? (
                ...
                >
                  <thead>
                    <tr className={isDarkMode ? "bg-gray-600" : "bg-gray-400"}>
                      <th className="px-4 py-3 text-left border-b border-gray-300 dark:border-gray-600">
                        Name
                      </th>
                      <th className="px-4 py-3 text-left border-b border-gray-300 dark:border-gray-600">
                        Email
              ...
              <p className="px-6 text-gray-500">No merchants available.</p>
            )}
          </section>
        </div>
        ...
        >
          <h2 className="mb-6 text-2xl font-bold text-center">Your Crops</h2>
              ...
              {crops.map((crop) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 mt-2 text-white transition bg-red-600 rounded-md hover:bg-red-700"
                  >
                    Delete Crop
                  </button>
                </div>
        ...
        >
          <h2 className="mb-4 text-xl font-semibold">Dashboard Actions</h2>
